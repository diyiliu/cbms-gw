...
import com.tianze.listener.impl.WorkAlarmImpl;
...
public class Cmd_04 extends CbBaseParser {
    ...
    public void parser(Object message, Object ctx) {
        ...
        WorkAlarmImpl.DEAL_INFO.offer(new WorkAlarmBean(entity.getVehicleId(), lat, lng, gpsTime, softVersion, packageValues));
    }
