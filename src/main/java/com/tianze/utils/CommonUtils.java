...
public class CommonUtils {
     ...
     * @return
     */
    public static Date correctionTime(Date date1, Date date2, int hour) {

        if (Math.abs(date1.getTime() - date2.getTime()) > (3600000 * hour)) {
    ...
    public static void dealInfoTODb(String table, String user, Map values) {
        ...
        DbpClient.queue.offer(createSqlUtils.getSql());
    }
